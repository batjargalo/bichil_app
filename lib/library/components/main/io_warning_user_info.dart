...
class IOWarningUserInfo extends StatelessWidget {
  final IOWarningUserInfoType type;
  final String? titleText;
  final String bodyText;
  final String? acceptText;

  final bool dismissable;
  const IOWarningUserInfo({
    super.key,
    required this.type,
            ...
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: switch (type) {
                    IOWarningUserInfoType.success => IOColors.infoSecondary,
                    IOWarningUserInfoType.error => IOColors.errorSecondary,
                    IOWarningUserInfoType.warning => IOColors.warningSecondary,
                  },
                ),
                child: SvgPicture.asset(
                  ...
                  colorFilter: ColorFilter.mode(switch (type) {
                    IOWarningUserInfoType.success => IOColors.infoPrimary,
                    IOWarningUserInfoType.error => IOColors.errorPrimary,
                    IOWarningUserInfoType.warning => IOColors.warningPrimary,
                  }, BlendMode.srcIn),
                ),
              ),
            ),
                  ...
                  children: [
                    Expanded(
                      child: IOButtonWidget(
                        onPressed: () => {Get.back(), MenuRoute.toUserInfo()},
                        model: IOButtonModel(
