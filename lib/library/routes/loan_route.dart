...
class LoanRoute {
  ...
  static Future<dynamic>? toCreateSavingAmount({required List<SavingDetailModel> saving}) {
    return Get.to(
  ...
  static Future? toCreateAmount() {
    return Get.to(() => const DigitalLoanCreateAmountScreen(), binding: DigitalLoanCreateAmountBinding());
  }
  ...
  static Future<JSON?>? toDigitalLoanContract({required DigitalLoanCreateModel item}) {
    return Get.to(
  ...
  static Future<JSON?>? toDigitalLoanSignature({int? contractId, DigitalLoanCreateModel? item}) {
    return Get.to(
  ...
  static Future<JSON?>? toSignedContract() {
    return Get.to(() => const ContractScreen(), binding: ContractBinding());
  }
}
