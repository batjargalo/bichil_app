...
class IOPages {
  static String get initial =>
      ...
      HelperManager.isSavedBiometric
          ? SignInBioScreen.routeName
          : SignInUserScreen.routeName;

  static final pages = [
    GetPage(
      name: SignInUserScreen.routeName,
      page: () => const SignInUserScreen(),
      binding: SignInUserBinding(),
    ),
    GetPage(
      name: SignInBioScreen.routeName,
      page: () => const SignInBioScreen(),
      binding: SignInBioBinding(),
    ),
    GetPage(
